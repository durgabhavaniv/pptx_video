...
%>
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Enter your command" aria-label="Recipient's username" aria-describedby="button-addon2" id="CommandInput">
              <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="button" id="button-addon2" onclick="processing()">execute</button>
              </div>
            </div>
            <div id="loading"></div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-8">
            <h3>Result</h3>
            <div class="upload-response-process">
