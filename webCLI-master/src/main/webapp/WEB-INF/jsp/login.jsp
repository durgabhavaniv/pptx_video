...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" >
      <div class="row">
        <div class="col" style="background-image: url('/resources/images/cbg_1.png'); background-repeat: no-repeat;">
        ...
        <div class="col-6" >
          <form action="<%= request.getContextPath()%>/loginSubmit" method="post">
                <div class="form-group">
                  ...
                  <small id="emailHelp" class="form-text text-muted">contact zlabs team if you are not a registered user</small>
                </div>
                <div class="form-group">
