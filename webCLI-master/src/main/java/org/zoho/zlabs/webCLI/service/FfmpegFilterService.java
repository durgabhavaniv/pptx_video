...
public class FfmpegFilterService {
    ...
    public String loadVideoFromPPTX(MultipartFile file){
        ...
        commandExecuter.processCommand(applicationProperties.getFfmpegVideoScriptfile()+" "+
                applicationProperties.getFfmpegVideoInDir()+fileName+" "+
                applicationProperties.getFfmpegVideoOutDir()+" "+
...
//        System.out.println (applicationProperties.getPptxVideoOutDir()+fileName.replaceFirst("[.][^.]+$", "/"));
        Path outPath = Paths.get(applicationProperties.getFfmpegVideoOutDir()+fileName.replaceFirst("[.][^.]+$", "/"))
                .toAbsolutePath().normalize();
